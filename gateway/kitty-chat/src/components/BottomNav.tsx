...
const CORE_ITEMS = [
  ...
  { id: 'projects', label: 'Projects', d: 'M4 5 H13 V19 H4 Z M17 7 H20 V17 H17 Z M17 5 L14 8' },
...
export function BottomNav({ activeView = 'home', onViewChange }: Props) {
  ...
  return (
    <>
      ...
      {moreOpen && (
        <div style={{
          position: 'fixed', bottom: 'calc(var(--bottom-nav-height) + 6px)',
          right: 12, zIndex: 46,
          ...
          {MORE_ITEMS.map(({ id, label, d }) => (
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                color: activeView === id ? 'var(--cat-ginger)' : 'var(--ink-2)',
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background: 'transparent',
            cursor: 'pointer',
            color: isMoreActive ? 'var(--cat-ginger)' : 'var(--ink-2)',
            flex: '1 1 0',
            minWidth: 0,
            minHeight: 40,
          }}
        >
          <svg viewBox="0 0 24 24" style={{ width: 22, height: 22, flexShrink: 0 }}>
            <path d="M4 7 H20 M4 12 H20 M4 17 H20 M9 5 V9 M15 10 V14 M8 15 V19" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span style={{
            fontSize: 9, fontWeight: 600, letterSpacing: '0.02em',
            maxWidth: '100%', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
