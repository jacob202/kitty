...
export function ProjectWorkspace({
  ...
  const dialogRef = useDialogFocus({ open: true, enabled: !selectedArtifact, onClose })
...
const backdropStyle: CSSProperties = { position: 'fixed', inset: 0, zIndex: 1225, background: 'var(--overlay-backdrop)', display: 'flex', justifyContent: 'flex-end' }
