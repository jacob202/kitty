...
class CronCronSchedulesResponse(BaseModel):
    model_config = {"extra": "allow"}


class CronCronActionsResponse(BaseModel):
    model_config = {"extra": "allow"}


class CronCronScheduleResponse(BaseModel):
    model_config = {"extra": "allow"}


class CronCronScheduleSidResponse(BaseModel):
    model_config = {"extra": "allow"}
...
class CronCronScheduleSidToggleResponse(BaseModel):
    model_config = {"extra": "allow"}
...
@router.get("/cron/schedules", response_model=CronCronSchedulesResponse)
...
@router.get("/cron/actions", response_model=CronCronActionsResponse)
...
@router.post("/cron/schedule", response_model=CronCronScheduleResponse)
...
@router.delete("/cron/schedule/{sid}", response_model=CronCronScheduleSidResponse)
...
@router.patch("/cron/schedule/{sid}", response_model=CronCronScheduleSidResponse)
...
@router.post("/cron/schedule/{sid}/toggle", response_model=CronCronScheduleSidToggleResponse)
