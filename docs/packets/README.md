...
| 005 | Mail read-only connector                                      | Codex/Claude Code + Jacob (credentials)       | 🔎 PR #99 — opencode 2026-07-04 (mocked tests; live OAuth blocked on Jacob) |
| 006 | Project resume                                                | Claude Code                                   | ✓ shipped (#71)                                                             |
| 007 | Delegation packet generator                                   | strongest model (template) + Codex (plumbing) | ✓ shipped (Jacob committed eb3afad while session ran)                       |
