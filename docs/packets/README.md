...
**Updated:** 2026-07-12 (020/022/024/025 shipped; duplicate table removed)
...
| 005 | Mail read-only connector (Gmail, D11)                                                | Codex/Claude Code + Jacob (OAuth)    | ✅ shipped (#99)                                                          |
| 006 | Dev-session resume (`./kitty resume` — **not** Jacob's real-world projects; see 021) | Claude Code                          | ✅ shipped (#71)                                                          |
| 007 | Delegation packet generator                                                          | —                                    | ✅ shipped (eb3afad)                                                      |
| 008 | Knowledge library + expert retrieval                                                 | Claude Code / Codex                  | ✅ shipped (#111)                                                         |
...
| 015 | Phone channel: Kitty reaches Jacob (iMessage/Pushover)                               | Claude Code / Codex                  | ✅ shipped (#103)                                                         |
| 016 | Next-step navigator ("just tell me what B is")                                       | Claude Code + strongest-model prompt | ✅ shipped (#107, hardened #109)                                          |
...
| 020 | GitHub read-only connector                                                           | Codex / Claude Code                  | ✅ shipped (#156)                                                         |
| 021 | Project registry + resume (the real P6 — projects table, git/memory/signal composer) | Claude Code                          | ✅ shipped (#106)                                                         |
| 022 | Magic Kitty: cross-project insight synthesis (D13)                                   | strongest-model prompt + Claude Code | ✅ shipped (#153)                                                         |
| 023 | Memory taste + creative continuity (renumbered from 021, #101)                       | Claude Code / Codex + Jacob review   | ✅ shipped (#119 backend + #123 UI)                                       |
| 024 | Chat log idea mine (renumbered from 022, #102)                                       | strongest-model prompt + Claude Code | ✅ shipped (#152)                                                         |
| 025 | Imagegen pipeline v2: local-first, criteria-verified loop                            | Claude Code + Jacob (installs/taste) | ✅ shipped (#155)                                                         |
