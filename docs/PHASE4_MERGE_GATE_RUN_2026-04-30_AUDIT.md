...
348 passed, 2 warnings in 19.49s
...
```text
{"confidence":0.85,"conversation_id":null,"fallback_used":false,"ok":true,"response":"Provider fallback failed. Anthropic: Error code: 401 - {'type': 'error', 'error': {'type': 'authentication_error', 'message': 'invalid x-api-key'}, 'request_id': 'req_011CaaQ7NFBPejUZQXWiAjgu'}","safety_warnings":[],"sentiment":0.0,"sources":[],"specialist":"Kitty","suggested_followups":[]}
```
