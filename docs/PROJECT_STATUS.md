...
Review and commit the B4 storage router seam, then choose the next user-facing store deliberately. Do not migrate chats or journal without an explicit compatibility and rollback plan.
