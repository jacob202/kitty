...
| `planning_inputs` | `docs/plans/`, `docs/planning/`, `docs/packets/`, `docs/initiatives/` | Preserved ideas, evidence, candidate work, and executable contracts after explicit current approval | Priority, activation, or ownership merely by existing |
