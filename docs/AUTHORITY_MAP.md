...
| `control_surface` | `docs/ACTIVE_MISSION.md` | **The one live sequence, each step's real status, and the evidence for it.** Agents update this file rather than writing a new plan. Consolidated 2026-09-14 from three competing structures (mission steps, the return program's R-chain, roadmap phases). | Long-range definition of done (ROADMAP), architecture, or Builder execution truth |
| `planning_inputs` | `docs/packets/`, `docs/initiatives/` | Preserved ideas, evidence, candidate work, and executable contracts after explicit current approval | Priority, activation, or ownership merely by existing |
| `archived_planning` | `docs/archive/plans-2026-09-14/README.md` | The 80 plan-shaped documents retired on 2026-09-14 (former `docs/plans/`, `docs/superpowers/plans/`, `docs/superpowers/specs/`, `docs/phases/`, `docs/campaigns/`). History, never instruction. | Anything current |
