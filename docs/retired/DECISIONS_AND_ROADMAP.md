...
- **A4 — done.** Port reconciled to **8000** everywhere (the port the code actually binds — see Decision D10 below; the earlier "5001" note was corrected to match reality); `ARCHITECTURE.md` rewritten and de-duplicated; baseline refreshed in the docs.
