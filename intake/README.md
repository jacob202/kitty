...
Use this folder for proposed Kitty work before it becomes an implementation spec.
...
Start from `docs/BUILDER_INTAKE.md` and convert ready work into `specs/_template.md`.
