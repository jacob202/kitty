...
class TestRunRecords:
    ...
    def test_update_run_expected_state_guard(self, db_path: Path):
        ...
        run = bq.create_run(task["id"], ["x"], db_path=db_path)
