...
- **Orchestrator**: `skills/open-code/SKILL.md` — runs this as Stage 2.5 (TypeScript projects only)
- **Pre-review cleanup**: `skills/code-cleanup/SKILL.md` — clean code before deep review
- **Security patterns**: `skills/code-optimization/SKILL.md` — shares security grep patterns
- **Deployment**: `skills/deployment-safety-review/SKILL.md` — findings feed into risk analysis
