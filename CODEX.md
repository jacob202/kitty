...
Token optimization and project practices for OpenAI Codex agent.

## Token Optimization Practices

Applies to all Codex operations in this repository.
...
- Preserve dirty changes — never revert unrelated dirty changes
...
- Fall back to: `developers.openai.com`, `platform.openai.com`, `openai.com`

## Monitoring
- Token log: `data/kitty_token_log.jsonl` (symlink to `.kitty_builder_token_usage.jsonl`)
