...
Reads SESSION_HANDOFF.md and extracts the most recent date. Exits 0 if the
...
HANDOFF_FILE = ROOT / "SESSION_HANDOFF.md"
...
def main() -> int:
    ...
    print(
        f"OK: SESSION_HANDOFF.md is {age_days} days old "
        f"(limit: {args.max_age_days} days, last updated: {handoff_date})"
    )
    return 0
